...
<head>
    ...
    <title>Style with J - Stylist Portfolio</title>
    ...
    <div class="vs-menu-wrapper">
        <div class="vs-menu-area text-center">
            ...
            <div class="mobile-logo">
                <a href="/"><img src="assets/img/main-logo.png" alt="Style with J"></a>
            </div>
    ...
    <div class="sidemenu-wrapper d-none d-lg-block  ">
        <div class="sidemenu-content">
            ...
            <div class="widget  ">
                ...
                <div class="mb-3">
                    <p style="font-size:15px;">Style With J helps you discover, refine, and express your personal style with confidence. Virtual and in-person styling available.</p>
                </div>
                <div class="info-media1">
                    <div class="media-icon"><i class="fal fa-map-marker-alt"></i></div>
                    <span class="media-label">Virtual & In-Person (Your City)</span>
                </div>
                <div class="info-media1">
                    <div class="media-icon"><i class="far fa-phone-alt "></i></div>
                    <span class="media-label"><a href="tel:+01234567890" class="text-inherit">[Your Number]</a></span>
                </div>
                <div class="info-media1">
                    <div class="media-icon"><i class="fal fa-envelope"></i></div>
                    <span class="media-label"><a class="text-inherit" href="mailto:sample@gmail.com">sample@gmail.com</a></span>
                </div>
            </div>
            <div class="widget  ">
                <h3 class="widget_title">Quick Links</h3>
                <ul style="list-style:none; padding-left:0;">
                    <li><a href="about" class="text-inherit">About</a></li>
                    <li><a href="service" class="text-inherit">Services</a></li>
                    <li><a href="blog" class="text-inherit">Blog</a></li>
                    <li><a href="appointment" class="text-inherit">Book a Session</a></li>
                    <li><a href="contact" class="text-inherit">Contact</a></li>
                </ul>
            </div>
        </div>
    </div><!--==============================
